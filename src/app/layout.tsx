...
export const metadata: Metadata = {
  ...
  description:
    "Grain donation drive by the only social service committee of D.J. Sanghvi NSS",
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        <link rel="icon" href="/DJSNSSLogo.png" />
        <link rel="mask-icon" href="/DJSNSSLogo.png" color="#000000" />
      </head>
      <body
      ...
      >
        ...
        <div className="min-h-screen w-[100vw] max-w-full m-0 p-0 overflow-x-hidden overflow-y-auto transition-all">
          <div className="h-full w-full max-w-full flex flex-col lg:flex-row justify-between items-start flex-nowrap bg-gradient-to-b from-red-500 to-red-950 cinema-background-home">
            ...
            <div className="md:w-[73%] w-full flex justify-center items-center flex-col">
              {children}
            </div>
